...
*   Values:
*     - PWM_Green_CMD_CAPTURE    - Trigger Capture command
*     - PWM_Green_CMD_RELOAD     - Trigger Reload command
*     - PWM_Green_CMD_STOP       - Trigger Stop command
*     - PWM_Green_CMD_START      - Trigger Start command
*
* Return:
*  None
*
